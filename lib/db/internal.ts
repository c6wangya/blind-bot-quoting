...
export const REFUND_COLS =
  "id, orderId:order_id, amount, returnedValue:returned_value, replacementValue:replacement_value, " +
  "reason, docPaths:doc_paths, lineItems:line_items, replacementItems:replacement_items, restocked, createdAt:created_at";
